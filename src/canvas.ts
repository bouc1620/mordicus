...
import { Coordinates, GridType } from './grid';
...
export class Canvas {
  ...
  private _clearScreen(color: string = '#000000'): void {
    this._context.fillStyle = color;
    this._context.fillRect(0, 0, Canvas.width, Canvas.height);
  }

  private _drawGrid(grid: GridType): void {
  ...
  private _getSprite(unit: UnitType): [HTMLImageElement, DrawImageViewBox] {
  ...
  private _loadSprites$(): Observable<unknown> {
    return from(createImageFromFilepath('/png/sprites.png')).pipe(
      tap((sprites) => {
  ...
  private _loadMenus$(): Observable<unknown> {
    return from(
      Promise.all(
        Object.entries({
          gameTitleOriginal: '/png/game-title-original.png',
          gameTitleSimple: '/png/game-title-simple.png',
          dialogBox: '/png/dialog-box.png',
          inGameMenus: '/png/in-game-menus.png',
  ...
  private _loadCharacterSets$(): Observable<unknown> {
    return from(
      Promise.all(
        Object.entries({
          lettersYellow: '/png/letters-yellow.png',
          lettersBlue: '/png/letters-blue.png',
          numbersYellow: '/png/numbers-yellow.png',
          numbersBlue: '/png/numbers-blue.png',
          specialsYellow: '/png/special-characters-yellow.png',
          specialsBlue: '/png/special-characters-blue.png',
